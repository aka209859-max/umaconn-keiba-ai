...
BASE_TIMES = {
    ...
    # ================================
    '42': {  # 大井競馬場
        1000: {'zenhan_3f': 34.8, 'kohan_3f': 37.2},  # 短距離
        ...
        2400: {'zenhan_3f': 38.0, 'kohan_3f': 40.5},  # 長距離
    },
    '43': {  # 川崎競馬場
    ...
    '30': {  # 北海道（門別）
        ...
        1600: {'zenhan_3f': 36.8, 'kohan_3f': 39.3},  # 基準距離（やや遅い馬場）
    ...
    '35': {  # 岩手（盛岡）
        ...
        1600: {'zenhan_3f': 37.0, 'kohan_3f': 39.5},  # 基準距離（砂質が重い）
    ...
    '46': {  # 笠松
        800:  {'zenhan_3f': 34.5, 'kohan_3f': 37.0},
    ...
    '50': {  # 高知
        ...
        1400: {'zenhan_3f': 36.3, 'kohan_3f': 38.8},
        1600: {'zenhan_3f': 37.0, 'kohan_3f': 39.5},  # 基準距離（やや重い馬場）
