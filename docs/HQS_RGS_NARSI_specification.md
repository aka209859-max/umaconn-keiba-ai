...
| システム | 役割 | 出力 |
|---------|------|------|
| **NAR-SI 3.0** | 走破タイムの絶対評価 | スピード指数（-100 ~ +100） |
| **HQS得点** | 馬の総合能力の相対評価 | HQS得点（-12 ~ +12） |
| **RGS** | レースの格付けとレベル評価 | RGSスコア（未定） |
