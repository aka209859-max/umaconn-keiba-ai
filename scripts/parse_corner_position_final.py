...
if __name__ == "__main__":
    test_cases = [
        # ケース1: (4,9) = 同着6位
        ('115,7,11,3,8,12,(4,9),10,2,1,6                                          ', '4', 6),
        ('115,7,11,3,8,12,(4,9),10,2,1,6                                          ', '9', 6),
        # ケース2: (5,2,7) = 同着2位、1-9 = 同着5位
        ('414,8,(5,2,7),1-9,(3,6)                                                 ', '9', 5),
        ('414,8,(5,2,7),1-9,(3,6)                                                 ', '1', 5),
        # ケース3: 7-8 = 同着4位
        ('412,10,6,9,7-8,5,1,3=4                                                  ', '7', 4),
        ('412,10,6,9,7-8,5,1,3=4                                                  ', '8', 4),
        # ケース4: 3=4 = 同着8位
        ('412,10,6,9,7-8,5,1,3=4                                                  ', '3', 8),
        ('412,10,6,9,7-8,5,1,3=4                                                  ', '4', 8),
        # ケース5: 5-(6,10,9) = 同着5位（4頭）
        ('314,8,2,1,7,5-(6,10,9),3                                                ', '5', 5),
        ('314,8,2,1,7,5-(6,10,9),3                                                ', '6', 5),
        # ケース6: 4=1 = 同着3位
